...
export default function NavBar({ sendMovies, children }) {
  ...
  if(currentUser !== null && context.themeColor === "dark") {
    return LoggedInPageDark;
  } else if(context.themeColor === "dark") {
    return GuestPageDark;
  }
  if (currentUser !== null && context.themeColor === "light") {
    return LoggedInPage;
  } else {
    return GuestPage;
  }
