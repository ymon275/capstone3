...
function uncontrolledPropTypes(controlledValues, displayName) {
  ...
  Object.keys(controlledValues).forEach(function (prop) {
    ...
    if (true) {
      ...
      !(typeof handler === 'string' && handler.trim().length) ?  true ? browser_default()(false, 'Uncontrollable - [%s]: the prop `%s` needs a valid handler key name in order to make it uncontrollable', displayName, prop) : undefined : void 0;
...
var react_lifecycles_compat_es = __webpack_require__(43);
...
function uncontrollable(Component, controlledValues, methods) {
  ...
  !(canAcceptRef || !methods.length) ?  true ? browser_default()(false, '[uncontrollable] stateless function components cannot pass through methods ' + 'because they have no associated instances. Check component: ' + displayName + ', ' + 'attempting to pass through methods: ' + methods.join(', ')) : undefined : void 0;
  ...
  Object(react_lifecycles_compat_es["a" /* polyfill */])(UncontrolledComponent);
...
//# sourceMappingURL=vendors.uncontrollable.32964a01.js.map