...
// UNUSED EXPORTS: UNMOUNTED, EXITED, EXITING
...
var timeoutsShape =  true ? prop_types_default.a.oneOfType([prop_types_default.a.number, prop_types_default.a.shape({
  enter: prop_types_default.a.number,
  exit: prop_types_default.a.number,
  appear: prop_types_default.a.number
}).isRequired]) : undefined;
var classNamesShape =  true ? prop_types_default.a.oneOfType([prop_types_default.a.string, prop_types_default.a.shape({
  enter: prop_types_default.a.string,
  exit: prop_types_default.a.string,
  active: prop_types_default.a.string
}), prop_types_default.a.shape({
  enter: prop_types_default.a.string,
  enterDone: prop_types_default.a.string,
  enterActive: prop_types_default.a.string,
  exit: prop_types_default.a.string,
  exitDone: prop_types_default.a.string,
  exitActive: prop_types_default.a.string
})]) : undefined;
...
Transition_Transition.propTypes =  true ? {
   ...
   */
  nodeRef: prop_types_default.a.shape({
    current: typeof Element === 'undefined' ? prop_types_default.a.any : function (propValue, key, componentName, location, propFullName, secret) {
      var value = propValue[key];
      return prop_types_default.a.instanceOf(value && 'ownerDocument' in value ? value.ownerDocument.defaultView.Element : Element)(propValue, key, componentName, location, propFullName, secret);
    }
  }),
   ...
   * ```
   */
  children: prop_types_default.a.oneOfType([prop_types_default.a.func.isRequired, prop_types_default.a.element.isRequired]).isRequired,
   ...
   */
  enter: prop_types_default.a.bool,

  /**
   * Enable or disable exit transitions.
   */
  exit: prop_types_default.a.bool,
   ...
   * ```
   */
  addEndListener: prop_types_default.a.func,
...
/* harmony default export */ var esm_Transition = __webpack_exports__["c"] = (Transition_Transition);

/***/ })

}]);
//# sourceMappingURL=vendors.react-transition-group.e4a186e4.js.map