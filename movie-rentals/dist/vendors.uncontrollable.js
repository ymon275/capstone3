"use strict";
(self["webpackChunkmovie_rentals"] = self["webpackChunkmovie_rentals"] || []).push([[505],{
...
function uncontrolledPropTypes(controlledValues, displayName) {
  ...
  Object.keys(controlledValues).forEach(function (prop) {
    ...
    if (true) {
      ...
      !(typeof handler === 'string' && handler.trim().length) ?  true ? invariant(false, 'Uncontrollable - [%s]: the prop `%s` needs a valid handler key name in order to make it uncontrollable', displayName, prop) : 0 : void 0;
...
function uncontrollable(Component, controlledValues, methods) {
  ...
  !(canAcceptRef || !methods.length) ?  true ? invariant(false, '[uncontrollable] stateless function components cannot pass through methods ' + 'because they have no associated instances. Check component: ' + displayName + ', ' + 'attempting to pass through methods: ' + methods.join(', ')) : 0 : void 0;
...
//# sourceMappingURL=vendors.uncontrollable.js.map