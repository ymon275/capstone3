"use strict";
(self["webpackChunkmovie_rentals"] = self["webpackChunkmovie_rentals"] || []).push([[165],{
...
__webpack_require__.d(__webpack_exports__, {
  "kZ": function() { return /* binding */ popperGenerator; }
});
...
function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
  ...
  var rect = (0,getBoundingClientRect/* default */.Z)(elementOrVirtualElement, offsetParentIsScaled);
  var scroll = {
    scrollLeft: 0,
    scrollTop: 0
  };
  ...
  modifiers.forEach(function (modifier) {
    ...
    .filter(function (value, index, self) {
      ...
      switch (key) {
        ...
        case 'phase':
          if (enums/* modifierPhases.indexOf */.xs.indexOf(modifier.phase) < 0) {
            console.error(format(INVALID_MODIFIER_ERROR, modifier.name, '"phase"', "either " + enums/* modifierPhases.join */.xs.join(', '), "\"" + String(modifier.phase) + "\""));
          }
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          ...
          if ((0,getBasePlacement/* default */.Z)(state.options.placement) === enums/* auto */.d7) {
          ...
          var _getComputedStyle = (0,getComputedStyle/* default */.Z)(popper),
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ getOffsetParent; }
});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ listScrollParents; }
});
...
/* harmony import */ var _dom_utils_contains_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4985);
/* harmony import */ var _dom_utils_getOffsetParent_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3779);
...
/* harmony import */ var _dom_utils_instanceOf_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2556);
...
function effect(_ref2) {
  ...
  if (true) {
    if (!(0,_dom_utils_instanceOf_js__WEBPACK_IMPORTED_MODULE_8__/* .isHTMLElement */ .Re)(arrowElement)) {
      console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', 'To use an SVG arrow, wrap it in an HTMLElement that will be used as', 'the arrow.'].join(' '));
    }
  }

  if (!(0,_dom_utils_contains_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)(state.elements.popper, arrowElement)) {
    if (true) {
...
/* harmony import */ var _dom_utils_getOffsetParent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3779);
...
function computeStyles(_ref4) {
  ...
  if (true) {
    var transitionProperty = (0,_dom_utils_getComputedStyle_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(state.elements.popper).transitionProperty || '';
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis || checkAltAxis) {
    ...
    if (checkMainAxis) {
      var preventedOffset = (0,within/* default */.Z)(tether ? (0,math/* min */.VV)(min, tetherMin) : min, offset, tether ? (0,math/* max */.Fp)(max, tetherMax) : max);
    ...
    if (checkAltAxis) {
      ...
      var _preventedOffset = (0,within/* default */.Z)(tether ? (0,math/* min */.VV)(_min, tetherMin) : _min, _offset, tether ? (0,math/* max */.Fp)(_max, tetherMax) : _max);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ detectOverflow; }
});
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ within; }
/* harmony export */ });
...
//# sourceMappingURL=vendors.popperjs.js.map